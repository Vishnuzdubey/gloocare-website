          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4 items-start sm:items-center">
              <div className="flex flex-wrap gap-4">
                {/* App Store badge — link to be updated when app is live */}
                <Link
                  href="#"
                ...
                >
                  <svg className="w-6 h-6 text-[#F7F2E9] group-hover:text-brand-gold transition-colors" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className="text-left leading-none">
                    <p className="text-[9px] uppercase text-[#F7F2E9]/80 font-bold tracking-wider">Download on the</p>
                    <p className="text-sm font-heading font-extrabold text-white mt-1">App Store</p>
                  </div>
                </Link>

                {/* Google Play badge — link to be updated when app is live */}
                <Link
                  href="#"
                  className="h-14 w-48 bg-[#3A2E25] border border-brand-gold/15 hover:border-brand-gold/35 rounded-2xl flex items-center justify-center gap-3.5 transition-all hover:scale-[1.02] group shadow-lg"
                >
              ...
              {/* Decorative QR placeholder — replace with real QR when app is live */}
              <div className="flex items-center gap-3.5 bg-[#3A2E25] border border-brand-gold/15 p-3 rounded-2xl shadow-lg">
                <div className="w-14 h-14 bg-white p-2 rounded-xl flex items-center justify-center">
                  <svg viewBox="0 0 21 21" className="w-full h-full text-[#1B1712]">
                    <rect width="7" height="7" fill="currentColor" />
                    <rect x="2" y="2" width="3" height="3" fill="white" />
                    <rect x="14" width="7" height="7" fill="currentColor" />
                    <rect x="16" y="2" width="3" height="3" fill="white" />
                    <rect y="14" width="7" height="7" fill="currentColor" />
                ...
                <div>
                  <p className="text-[9px] text-brand-gold font-bold uppercase tracking-wider">Scan to Install</p>
                  <p className="text-xs text-white mt-1">iOS &amp; Android</p>
                </div>
              </div>
            </div>
          </motion.div>
